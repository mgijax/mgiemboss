#!/bin/sh
#
# This script works for both refSeq and genBank releases
#
# Assumption:
# 1. The script is called  only by either refSeq or genbank config scripts
# 2. The files have already been copied/unzipped from hobbiton to /data/databases/***/temp
